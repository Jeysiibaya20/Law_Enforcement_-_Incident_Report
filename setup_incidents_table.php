...
try {
    ...
    $sql = "CREATE TABLE IF NOT EXISTS incidents (
        ...
        status ENUM('Draft', 'Pending', 'Submitted', 'Under Review', 'Verified', 'Forwarded', 'Resolved', 'Closed', 'Archived') DEFAULT 'Draft',
        ...
        forwarded_to_groups VARCHAR(255) NULL,
        is_forwarded TINYINT(1) NOT NULL DEFAULT 0,
        forwarded_at DATETIME NULL,
        primary_group_id VARCHAR(20) NULL,
        forwarding_notes TEXT NULL,
