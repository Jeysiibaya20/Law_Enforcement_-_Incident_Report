<?php
/**
 * Evidence Tables Setup - Web Accessible Version
 * Access this file via browser to create the evidence tables
 */

require_once 'config/db_connect.php';

echo "<h2>Evidence Collection Tables Setup</h2>";
echo "<pre>";
...
try {
    ...
    if ($table_exists) {
        echo "[OK] evidence_records table already exists\n";
    } else {
        echo "Creating evidence_records table...\n";
        $pdo->exec("
        ...
        ");
        echo "[OK] evidence_records table created successfully\n";
    }
    ...
    if ($table_exists) {
        echo "[OK] evidence_attachments table already exists\n";
    } else {
        echo "Creating evidence_attachments table...\n";
        $pdo->exec("
        ...
        ");
        echo "[OK] evidence_attachments table created successfully\n";
    }
    ...
    if ($table_exists) {
        echo "[OK] chain_of_custody table already exists\n";
    } else {
        echo "Creating chain_of_custody table...\n";
        $pdo->exec("
        ...
        ");
        echo "[OK] chain_of_custody table created successfully\n";
    }
    ...
    echo "\n<strong>All evidence management tables are now ready!</strong>\n";
    echo "You can now use the evidence collection and chain of custody system.\n";
    echo "\n<a href='modules/evidence_collection.php'>Go to Evidence Collection System</a>\n";
